// @see https://www.tutorialspoint.com/design_pattern/filter_pattern.htm
// @running npx tsx docs/aulas/criteria-pattern/criteria.ts
interface ICriteria {
...
andCriteria = new AndCriteria([new FindByNameCriteria('Category 2'), new FindByDescriptionCriteria('Description 2')]);
