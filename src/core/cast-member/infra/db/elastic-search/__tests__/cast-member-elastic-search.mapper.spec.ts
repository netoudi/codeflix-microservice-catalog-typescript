...
describe('CastMemberElasticSearchMapper', () => {
  ...
  describe('toEntity', () => {
    it('should convert document to entity', () => {
      const result = CastMemberElasticSearchMapper.toEntity(castMember.cast_member_id.id, castMemberDocument);
      ...
      const result2 = CastMemberElasticSearchMapper.toEntity(castMember.cast_member_id.id, castMemberDocument);
