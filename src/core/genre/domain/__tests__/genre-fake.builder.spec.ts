...
describe('GenreFakerBuilder Unit Tests', () => {
  ...
  it('should create a genre', () => {
    ...
    expect(genre.categories.values().next().value).toBeInstanceOf(NestedCategory);
    ...
    expect(genre.categories.get(nestedCategory1.category_id.id)).toBe(nestedCategory1);
    expect(genre.categories.get(nestedCategory2.category_id.id)).toBe(nestedCategory2);
